...
export default function ProfilePage() {
    ...
    const handleBookmarkFormChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        const { name, value } = e.target;
         // Allow numbers and a single decimal point for lat/lon
    ...
    // --- Payment Method Management ---
     ...
     const handleSavePaymentMethods = async (updatedMethodsFromModal: PaymentMethod[], newPreferredId: string | undefined) => {
         ...
         try {
             // Call the service to update methods in the backend
             ...
             // Update userDetails with the new preferred ID (if it changed or if it's different from what service returned)
             ...
             // Refresh local state from the persistedMethods to ensure consistency
